...
/*
 * Optimization of the Kitchen.java program, attempt to prevent deadlock and maximise efficency 
 * by locking appliances in a predetermined order: oven, grill, microwave, mixer, blender, coffeeMaker, fryer, griddle
 */
